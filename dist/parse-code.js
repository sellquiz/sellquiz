...
export class ParseCode {
    ...
    parseAssign() {
        ...
        if (this.p.is(':=') || this.p.is('=')) {
            ...
            if (lhsMatrixIndexed) {
                ...
                lhs.value = LinAlg.SellLinAlg.mat_set_element(lhs.value, lhsMatrixRow - 1, lhsMatrixCol - 1, rhs.value);
                if (lhs.value == null)
            ...
            if (o1.type == symtype.T_REAL && o2.type == symtype.T_REAL) {
                ...
                switch (op) {
                    case '+':
                        ...
                        break;
                    case '-':
                        this.p.pushSym(symtype.T_COMPLEX, math.subtract(o1.value, o2.value));
                        break;
                }
            }
            else if (o1.type == symtype.T_MATRIX && o2.type == symtype.T_MATRIX) {
                let o1_m = o1.value.size()[0];
                let o1_n = o1.value.size()[1];
                let o2_m = o2.value.size()[0];
                let o2_n = o2.value.size()[1];
    ...
    parseMul() {
        ...
        while (this.p.is('*') || this.p.is('/') || this.p.is('mod')) {
            ...
            if (o1.type == symtype.T_REAL && o2.type == symtype.T_REAL) {
                ...
                switch (op) {
                    case '*':
                        this.p.pushSym(symtype.T_COMPLEX, math.multiply(o1.value, o2.value));
                        break;
                    case '/':
    ...
    parseFunctionCall() {
        ...
        if (functionName === 'abs') {
            ...
            this.p.pushSym(symtype.T_REAL, math.subset(math.xgcd(p[0].value, p[1].value), math.index(p[2].value - 1)));
        }
