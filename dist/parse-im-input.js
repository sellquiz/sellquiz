    ...
    parseIM_Input() {
        ...
        switch (sym.type) {
            ...
            case symtype.T_MATRIX_OF_FUNCTIONS:
                ...
                input.matrixInput = new MatrixInput(this.p.q, input, rows, cols, isWideInput, this.p.resizableRows, this.p.resizableCols);
...
//# sourceMappingURL=parse-im-input.js.map